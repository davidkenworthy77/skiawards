      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-2 text-white mb-6" aria-label="The Ski Awards — Home">
              <Mountain size={24} />
              <span className="text-xl font-bold tracking-tighter uppercase">The Ski Awards</span>
            </Link>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 gap-6">
          <p className="text-xs font-light tracking-widest uppercase">
            © 2026 The Ski Awards. All rights reserved.
          </p>
